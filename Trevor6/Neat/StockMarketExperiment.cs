...
{
    public class StockMarketExperiment: SimpleNeatExperiment
    {
        ...
        {
            get { return new StockMarketEvaluator(); }
        }
        ...
        /// </summary>
        public override int InputCount => (192 * 9) + 1; // todo dodelat konstanty
        ...
        /// </summary>
        public override int OutputCount => 2; // TODO dodelat konstanty
